...
?>
<div id="Updates" style="display:none;">A</div>
<!-- TABLE OF RESIDENCE -->
	<div id="display" style="display:hidden"></div>
	<div id="Residents" style="margin-top:20px;background-color:#5e798f63;border-radius: 25px;border-style: solid;display:<?php if(isset($_POST['search'])||isset($_GET['last'])||isset($_GET['delete'])){ echo 'block';}else{ echo 'none';}?>">
  ...
  if($results){
	...
	foreach($results as $row) {
		echo '
					...
					<td>'.$row['Birthday'].'</td>
					<td>'.$row['Age'].'</td>
					<td><a class="btn btn-primary btn-sm" href="update.php" style="width: 60px;">Update</a><a class="btn btn-danger btn-sm" href="delete.php?deleteid='.$row['ID'].'" style="width: 60px;">Delete</a></td>
					<td></td>
					</tr>
					</tbody>';
...
if(!isset($_POST['search'])){
  ...
  ?>
	...
	<!-- LIST REQUEST-->
	<div id="showlist" style="text-align:center;margin-top:20px;background-color:#5e798f63;border-radius: 25px;border-style: solid;display:<?php if(isset($_POST['searchrequest'])||isset($_GET['status'])){echo 'block';}else{ echo 'none';}?>">
  ...
  ?>
	...
	<?php
		...
		foreach($res as $row) {
			...
			echo '<small style="float:right;color:blue;margin-top: 40px;">'.date_format($date,"Y/m/d h:i") .'</small>';
...
<div class="card">
  <h2 style="text-align:center">IT22</h2>
  <img id="prof" src="Profile/drich.jpg" alt="John" style="width:100%">
